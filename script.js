document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        const validators = {
            ...
            tel: function(value) {
                return value.trim() === '' || /^[\d\s\-+()]{7,}$/.test(value);
            },
        ...
        function getFieldType(field) {
            ...
            if (field.hasAttribute('required') || field.classList.contains('required')) return 'required';
            return null;
        }
        ...
        function validateField(field) {
            ...
            if (type === 'required' && !validators.required(value)) {
                ...
                isValid = false;
                message = field.getAttribute('data-error-tel') || 'Please enter a valid phone number';
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8f07cd82-a058-4e90-a602-ef26b1b71c21',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8f07cd82-a058-4e90-a602-ef26b1b71c21';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8f07cd82-a058-4e90-a602-ef26b1b71c21';
